...
- `wist-agentd` 如何声明本机能力
- 控制平面如何筛选目标 agent
- `ActionPlan.constraints.required_capabilities` 如何在边缘校验

相关文档：

- [`control-plane.md`](../../../doc/design/center/control-plane.md)
- [`action-plan-schema.md`](../../../doc/design/execution/action-plan-schema.md)
- [`log-file-input-spec.md`](./log-file-input-spec.md)
- [`metrics-config-schema.md`](../../../doc/design/telemetry/metrics-config-schema.md)
